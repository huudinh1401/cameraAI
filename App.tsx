    ...
    return (
      <NavigationContainer>
        <Stack.Navigator 
          ...
          screenOptions={{ headerTintColor: 'white', headerStyle: { backgroundColor: 'orange' }, headerTitleAlign: 'center'}}
        >
          ...
          <Stack.Screen name="Black"        component={BlackList}             options={{ title: 'Danh sách cảnh báo'}} />
