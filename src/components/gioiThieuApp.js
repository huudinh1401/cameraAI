    ...
    return (
      <View style = { styles.container}>
        <View style={{width: '100%', height: 45, justifyContent:'center', alignItems:'center'}}>
            <Text style={{color: '#990000', fontWeight:'bold', fontSize: 18}}>Giới thiệu & hướng dẫn</Text>
        </View>

        <View style={{width: '90%', marginTop: 10}}>
            <Text style={{color: 'black', fontSize: 15, textAlign: 'justify', lineHeight: 22}}>     Camera - AI là ứng dụng
        ...
        <View style={{width: '90%', marginTop: 10}}>
            <Text style={{color: 'black', fontSize: 15, textAlign: 'justify', lineHeight: 22}}>     Camera - AI sử dụng kỹ thuật 
        ...
        <View style={{width: '90%', marginTop: 10}}>
            <Text style={{color: 'black', fontSize: 15, textAlign: 'justify', lineHeight: 22}}>     Công Ty TNHH Nguyên Luân
                rất hân hạnh được đóng góp công sức của mình vào sự phát triển chung của tỉnh nhà.
            </Text>
        </View>
        <View style={{width: '90%', marginTop: 20}}>
            <Text style={{color: 'black', fontSize: 15, right:0, position:'absolute'}}>Trân trọng!</Text>
        </View>
