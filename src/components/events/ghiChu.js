                ...
                <View style={{flexDirection: 'row'}}>
                    ...
                    <View style = {{flexDirection: 'row', marginTop: 10}}>
                        <View style={{justifyContent: 'center', flex: 1.5}}>
                            <Text style = {{color: 'red', marginLeft: 10, fontSize: 20 }}>textT</Text>
                        </View>
                    ...
                    <View style = {{flexDirection: 'row', marginTop: 10}}>
                        <View style={{justifyContent: 'center', flex: 1.5}}>
                            <Text style = {{color: 'green', marginLeft: 10, fontSize: 20, }}>textT</Text>
                        </View>
                        <View style={{justifyContent: 'center', flex: 8.5}}>
                    ...
                    <View style = {{flexDirection: 'row', marginTop: 10}}>
                        ...
                        <View style={{justifyContent: 'center', flex: 8.5}}>
                            <Text style = {{color: 'black', marginLeft: 10 }}>Chạm vào đối tượng để xem thông tin chi tiết.</Text>
                        </View>
                    </View>
            </View>
        </View>
